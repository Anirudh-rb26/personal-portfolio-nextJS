...
const Rocket = ({
    ...
    return (
        <div
            className="group p-2 inline-flex items-center justify-center cursor-pointer select-none"
        ...
        >
            <motion.svg
                ...
                variants={variants}
                animate={controls}
                className="transition-colors duration-300 group-hover:stroke-bubblegum-pink"
            >
                <motion.path
                    d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"
