    ...
    return (
        <section className="relative w-screen min-h-[90vh] flex items-center justify-center px-4">
            ...
            <div className="hidden sm:block z-10">
                ...
                <p className="pointer-events-none select-none absolute top-1/3 right-4 sm:right-16 text-[11px] sm:text-xs font-melodrama text-white/45 rotate-3">
                    {heroLabels[1]}
                </p>

                <p className="pointer-events-none select-none absolute bottom-14 left-1/4 text-[10px] sm:text-xs font-melodrama text-white/40 -rotate-2">
                    {heroLabels[2]}
                </p>
